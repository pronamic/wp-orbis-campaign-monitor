 ...
 * Deploy
 *
 * @package Pronamic\Orbis\CampaignMonitor
 */
...
set( 'plugin_slug', 'orbis-campaign-monitor' );
...
host( 'orbis.pronamic.nl' )
	...
	->set( 'port', 18765 )
	->set( 'deploy_path', '~/projects/wp-orbis-campaign-monitor' )
...
task(
	'deploy:update_code',
	function () {
		upload( '{{build_path}}/orbis-campaign-monitor/', '{{release_path}}' );
	}
);
